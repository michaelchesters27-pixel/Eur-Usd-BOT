...
EA_SOURCE = (
    Path(__file__).parents[1] / "mt5" / "EURUSD_5x5_CampaignBot.mq5"
).read_text(encoding="utf-8")


def test_ea_is_locked_to_eurusd_and_hedging_accounts():
    assert 'StringSubstr(_Symbol, 0, 6) != "EURUSD"' in EA_SOURCE
